...
rasteriser: raylib
ifneq (,$(rasteriser_config))
	@echo "==== Building rasteriser ($(rasteriser_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f rasteriser.make config=$(rasteriser_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f rasteriser.make clean
